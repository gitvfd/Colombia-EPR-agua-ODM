function step3(){
	...
	d3.json("data/water.json", function(error, data) {
        var colombiaData3=data.filter(function(d) {
            return((d.area=="Urbano" || d.area=="Rural") && d.year=="2010" && (d.country=="Colombia"))
        });
        var targetData3=data.filter(function(d) {
            return((d.area=="Urbano" || d.area=="Rural") && d.year=="1993" && (d.country=="Meta ODM 2015" || d.country=="Meta Nacional 2015"))});
