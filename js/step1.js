function step1(){
	...
	if(document.getElementById("selectedStep").innerHTML=="step2"){
		d3.json("data/water.json", function(error, data) {
		    ...
		    document.getElementById("textToDisplay").innerHTML = "Desde 1993, Colombia ha desarrollado sustancialmente su infraestructura para proveer el acceso al suministro de agua potable y a los sistemas de saneamiento";    
