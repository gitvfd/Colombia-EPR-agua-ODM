...
if(document.getElementById("selectedStep").innerHTML=="step3"){
	...
	d3.json("data/water.json", function(error, data) {
        ...
        var targetData=data.filter(function(d) {
            return(d.area=="Total" && d.year=="1993" && (d.country=="Meta ODM 2015" || d.country=="Meta Nacional 2015"))
        });
	    ...
	    document.getElementById("textToDisplay").innerHTML = "En el 2010, Colombia estuvo cerca de cumplir con el Objetivo de Desarrollo del Milenio en acceso al agua potable, sin embargo se requiere una mayor inversión para lograr la menta en el acceso al saneamiento";         
